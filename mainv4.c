...
{	
	...
	{	
		...
		warteschlange_tal[0].warteschlange_index = 0; /* skifahrer aus Warteschlangen_index loeschen */
...
{	
	...
	for (; j <= 3; j++)
	{
		...
		warteschlange_berg[0].warteschlange_index = 0; /* skifahrer aus Warteschlangen_index loeschen */
...
{	
	...
	for (; j < 24 - skifahrer_in_lift; j++)
	{
		...
		warteschlange_mitte_runter[0].warteschlange_index = 0; /* skifahrer aus Warteschlangen_index loeschen */
...
/* fuellt warteschlangen_liste mit Dummys. Soll verhindern, dass eine Funktion auf eine leere Stelle in den Schlangen zugreift und dabei Werte entdeckt, die es nicht geben sollte*/
void warteschlangenMitDummysFuellen()
{
	int i;
	...
	for (; i <= 5000; i++)
	{
		...
		warteschlange_tal[i].warteschlange_index = 0;
...
/* setzt Variabeln auf Null Hauptsaechlich zur Verwendung in positionenChecken() */
void zaehlvariablenAufNullSetzen()
{
